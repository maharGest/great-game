                ...
                while (monster.get("spider").equals(1)) {
                    ...
                    if (status.get("move").equals("f")) {
                        ...
                        monsterStatus.replace("currentHealth",
                                monsterStatus.get("currentHealth") - numberStatus.get("currentDamage"));
                        ...
                        if (monsterStatus.get("currentHealth") < 1) {
                            ...
                            stats.replace("exp", stats.get("exp") + (3 * stats.get("expGain")));
                            stats.replace("untilNextLevel", stats.get("untilNextLevel") - (3 * stats.get("expGain")));
                    ...
                    if (status.get("fightingOrShoping").equals("f")) {
                        ...
                        numberStatus.replace("currentHealth",
                                numberStatus.get("currentHealth") - monsterStats.get("spiderDamage"));
                ...
                while (monster.get("fly").equals(1)) {
                    ...
                    if (status.get("move").equals("f")) {
                        ...
                        if (monsterStatus.get("currentHealth") < 1) {
                            ...
                            stats.replace("exp", stats.get("exp") + (2 * stats.get("expGain")));
                            stats.replace("untilNextLevel", stats.get("untilNextLevel") - (2 * stats.get("expGain")));
                            System.out.println("you won! You now have " + stats.get("exp") + " exp, "
                                    + stats.get("money") + " money, and " + stats.get("untilNextLevel")
                                    + " exp until the next level");
                        ...
                        if (status.get("fightingOrShoping").equals("f")) {
                            ...
                            numberStatus.replace("currentHealth",
                                    numberStatus.get("currentHealth") - monsterStats.get("flyDamage"));
            ...
            while (monster.get("moth").equals(1)) {
                ...
                if (status.get("move").equals("f")) {
                    ...
                    if (monsterStatus.get("currentHealth") < 1) {
                        ...
                        stats.replace("exp", stats.get("exp") + (1 * stats.get("expGain")));
                        stats.replace("untilNextLevel", stats.get("untilNextLevel") - (1 * stats.get("expGain")));
                    ...
                    if (status.get("fightingOrShoping").equals("f")) {
                        ...
                        numberStatus.replace("currentHealth",
                                numberStatus.get("currentHealth") - monsterStats.get("mothDamage"));
